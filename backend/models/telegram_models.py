...
from sqlalchemy import Column, Integer, BigInteger, String, Text, Enum, TIMESTAMP, ForeignKey, Boolean
...
class TelegramUser(Base):
    ...
    role = Column(String(50), default=UserRole.USER.value, nullable=False)  # 改为 String 类型
...
class RepoSubscription(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    repo_name = Column(String(255), unique=True, nullable=False, index=True)  # 格式: owner/repo
    is_active = Column(Boolean, default=True, nullable=False)
